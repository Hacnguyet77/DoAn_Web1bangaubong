window.onload = function () {
	...
	autocomplete(document.getElementById('search-box'), list_products);
	 ...
	 var tags = ["gau bong", "goi","phu kien"];
	 for (var t of tags) addTags(t, "index.html?search=" + t);

	// Thêm danh sách hãng điện thoại
	//var phan_loai = ["gau.jpg", "goi.jpg", "phu.jpg"];
	//for (var c of phan_loai) addphan_loai("img/phan_loai/" + c, c.slice(0, c.length - 4));
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('GIÁ RẺ CHO MỌI NHÀ', green, ['price=0-200000', 'sort=price'], soLuong, div);
	}

	// Thêm chọn mức giá
	addPricesRange(0, 50000);
	addPricesRange(50000, 150000);
	addPricesRange(150000, 300000);
	addPricesRange(300000, 600000);
	addPricesRange(600000, 900000);
	addPricesRange(900000, 0);
