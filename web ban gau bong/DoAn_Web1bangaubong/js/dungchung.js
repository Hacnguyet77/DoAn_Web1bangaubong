	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a  class="fa fa-facebook" href="https://www.facebook.com/gaushoponline"></a>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="trungtambaohanh.html"><i class="fa fa-map-marker"></i> Chi nhánh</a></li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Pandas Store" title="Trang chủ Panda Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Panda Store</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">ginny</span></p>
    </div>`);
}
